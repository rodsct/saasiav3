...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative py-20 md:py-[120px]">
      ...
      <div className="absolute left-0 top-0 -z-[1] h-1/2 w-full bg-[#1e1e1e] lg:h-[45%] xl:h-1/2"></div>
      <div className="container px-4">
        <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="ud-contact-content-wrapper">
              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div className="mb-8 flex w-[330px] max-w-full">
                  <div className="mr-6 text-[32px] text-[#ff6b35]">
                    <svg
                      width="29"
                      height="35"
                      viewBox="0 0 29 35"
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
            <div
              className="wow fadeInUp rounded-lg bg-[#3f3f3f] px-8 py-10 shadow-lg sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]"
              data-wow-delay=".2s
              "
            >
