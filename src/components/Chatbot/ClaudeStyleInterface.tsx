...
export default function ClaudeStyleInterface({ chatbotId: initialChatbotId }: ChatbotProps) {
  ...
  useEffect(() => {
    const handleResize = () => {
      if (typeof window !== 'undefined') {
        ...
        const isKeyboardVisible = viewport && viewport.height < window.innerHeight * 0.8;
        setIsKeyboardOpen(isKeyboardVisible || false);
      }
    };
  ...
  return (
    <div className="h-screen md:h-[calc(100vh-80px)] bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] text-white md:flex overflow-hidden">
      ...
      {/* Main Chat Area */}  
      <div className="flex-1 flex flex-col min-w-0 h-full md:h-auto relative">
        {/* Mobile Header with Menu Button */}
        <div className="md:hidden flex items-center justify-between p-4 border-b border-[#00d4ff]/20 bg-[#0a0a0a]/95 flex-shrink-0">
        ...
        {messages.length === 0 ? (
          ...
          /* Messages Area */
          <div className="flex-1 overflow-y-auto">
            <div className="max-w-4xl mx-auto py-3 lg:py-8 pb-4 md:pb-8">
        ...
        {/* Input Area */}
        <div className="border-t border-[#3f3f3f] bg-[#2f2f2f] flex-shrink-0 pb-20 md:pb-0">
      ...
      {/* Mobile Bottom Menu */}
      <div className={`md:hidden fixed left-0 right-0 bg-[#0a0a0a]/95 border-t border-[#00d4ff]/20 backdrop-blur-xl z-50 transition-all duration-300 ${
        ...
        <div className="flex items-center justify-around py-3 px-2 pb-safe">
          ...
          <button
            ...
            className="flex flex-col items-center p-2 rounded-lg transition-colors text-[#00d4ff] bg-[#00d4ff]/20 min-w-0 flex-1"
          >
            <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
      ...
      {activeBottomTab === 'conversations' && (
        <div className="md:hidden fixed inset-0 bg-[#0a0a0a] z-40 animate-in slide-in-from-bottom duration-300">
