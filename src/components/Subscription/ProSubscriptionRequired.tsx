    ...
    <div className="min-h-screen bg-gradient-to-br from-[#00d4ff]/10 to-white dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
      <div className="max-w-lg w-full mx-auto p-8">
        <div className="text-center">
          {/* Icon */}
          <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-[#00d4ff] to-[#0099cc] flex items-center justify-center">
          ...
          <div className="text-left mb-8 bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
            ...
            <ul className="space-y-3 text-gray-600 dark:text-gray-300">
              <li className="flex items-center">
                <svg className="w-5 h-5 text-[#00d4ff] mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="space-y-4">
            <Link 
              href="/pricing"
              className="w-full block bg-gradient-to-r from-[#00d4ff] to-[#0099cc] text-white font-semibold py-4 px-6 rounded-xl hover:from-[#0099cc] hover:to-[#007acc] transition-all duration-200 shadow-lg hover:shadow-xl"
            >
